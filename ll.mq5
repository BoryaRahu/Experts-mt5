...
//+------------------------------------------------------------------+
//--- inputs for expert
input string Expert_Title                     ="ll";  // Document name
ulong        Expert_MagicNumber               =8789;  //
...
//--- Creating filter CSignalDUAL_RA
   CSignalDUAL_RA *filter0=new CSignalDUAL_RA;
   if(filter0==NULL)
     {
      //--- failed
...
//--- Set filter parameters
   filter0.Size(Signal_DUAL_RA_Size);
   filter0.OpenCollinearity(Signal_DUAL_RA_OpenCollinearity);
   filter0.OpenDetermination(Signal_DUAL_RA_OpenDetermination);
   filter0.CloseCollinearity(Signal_DUAL_RA_CloseCollinearity);
   filter0.CloseDetermination(Signal_DUAL_RA_CloseDetermination);
   filter0.OpenError(Signal_DUAL_RA_OpenError);
   filter0.OpenData(Signal_DUAL_RA_OpenData);
   filter0.CloseError(Signal_DUAL_RA_CloseError);
   filter0.CloseData(Signal_DUAL_RA_CloseData);
   filter0.Weight(Signal_DUAL_RA_Weight);
